...
//go:embed admin.html admin-provider.html admin-models.html admin-browser-login.html admin-free-pool.html admin-common.js admin-settings.js admin-network.js admin-share.js admin-logs.js setup.html login.html
var htmlFS embed.FS
