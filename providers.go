...
var presetProviders = []Provider{
	...
	{
		ID:       "kilo-gateway",
		Name:     "Kilo Gateway (免费)",
		Type:     "openai_compatible",
		BaseURL:  "https://api.kilo.ai/api/gateway",
		APIKey:   "free-anonymous",
		Enabled:  true,
		Priority: 3,
		Description: "Kilo Gateway 免费模型聚合网关，无需 API Key，包含 Nemotron/StepFun/Ling 等12个免费模型，支持最高1M上下文",
		Icon:      "kilo",
		APIKeyURL: "https://kilo.ai/",
		Models: []ModelDef{
			{ID: "kilo-auto/free", Name: "Auto Free (智能路由)", Enabled: true},
			{ID: "stepfun/step-3.7-flash:free", Name: "StepFun Step 3.7 Flash (free)", Enabled: true},
			{ID: "inclusionai/ling-3.0-flash:free", Name: "Ling-3.0-flash (free)", Enabled: true},
			{ID: "poolside/laguna-s-2.1:free", Name: "Laguna S 2.1 (free)", Enabled: true},
			{ID: "poolside/laguna-xs-2.1:free", Name: "Laguna XS 2.1 (free)", Enabled: true},
			{ID: "cohere/north-mini-code:free", Name: "North Mini Code (free)", Enabled: true},
			{ID: "nvidia/nemotron-3.5-content-safety:free", Name: "Nemotron 3.5 Content Safety (free)", Enabled: true},
			{ID: "nvidia/nemotron-3-ultra-550b-a55b:free", Name: "Nemotron 3 Ultra (free)", Enabled: true},
			{ID: "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free", Name: "Nemotron 3 Nano Omni (free)", Enabled: true},
			{ID: "nvidia/nemotron-3-super-120b-a12b:free", Name: "Nemotron 3 Super (free)", Enabled: true},
			{ID: "openrouter/free", Name: "OpenRouter Free Router", Enabled: true},
			{ID: "tencent/hy3:free", Name: "Tencent Hy3 (free)", Enabled: true},
		},
	},
}
